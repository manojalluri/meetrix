  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-zinc-50 p-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 z-0 pointer-events-none">
        <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-indigo-200/50 rounded-full blur-[128px]" />
        ...
        <Card className="bg-white border-zinc-200 shadow-xl rounded-3xl p-2 text-zinc-900">
          ...
          <form action={login}>
            ...
            <CardFooter className="flex flex-col gap-4">
              <SubmitButton className="w-full h-12 bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl shadow-[0_4_15px_rgba(79,70,229,0.2)] transition-all">
                Sign In
              </SubmitButton>
